...
var hideQuickButtons
class hideQuickButtonsClass {
    constructor() {
        this.removedItems = []
...
function enable() {
    hideQuickButtons = new hideQuickButtonsClass()
    hideQuickButtons.enable()
}

function disable() {
    hideQuickButtons.disable()
    hideQuickButtons = null
}
